...
function unirseAlJuego() {
    fetch("http://192.168.1.88:8080/unirse")
        .then(function (res) {
            if (res.ok) {
                res.text()
...
function seleccionarMokepon(mascotaJugador) {
    fetch(`http://192.168.1.88:8080/mokepon/${jugadorId}`, {
        method: "post",
        headers: {
...
function enviarAtaques() {
    fetch(`http://192.168.1.88:8080/mokepon/${jugadorId}/ataques`, {
        method: "post",
        headers: {
            "Content-Type": "application/json"
        },
...
function obtenerAtaques() {
    fetch(`http://192.168.1.88:8080/mokepon/${enemigoId}/ataques`)
    .then(function (res){
        if (res.ok){
            res.json()
...
function enviarPosicion(x, y) {
    fetch(`http://192.168.1.88:8080/mokepon/${jugadorId}/posicion`, {
        method: "post",
        headers: {
            "Content-Type": "application/json"
        },
